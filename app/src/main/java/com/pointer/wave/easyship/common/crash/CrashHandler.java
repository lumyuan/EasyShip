package com.pointer.wave.easyship.common.crash;
    ...
    public static void init(final Application app, final String crashDir) {
        Thread.setDefaultUncaughtExceptionHandler(new UncaughtExceptionHandler(){
            ...
            private void tryUncaughtException(Thread thread, Throwable throwable) {
                @SuppressLint("SimpleDateFormat") final String time = new SimpleDateFormat("yyyy_MM_dd-HH_mm_ss").format(new Date());
                ...
                sb.append("可点击右上角复制按钮复制，并提交给开发者\nQQ：2205903933").append("\n");
                sb.append("************* 软件发生错误 ****************\n");
    ...
    public static final class CrashActivity extends Activity implements MenuItem.OnMenuItemClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView: {
                ...
                Toast.makeText(this, "软件崩溃了，可长按文字复制并发送到开发者QQ进行提交", Toast.LENGTH_LONG).show();
            }
        }
