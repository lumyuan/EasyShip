package com.pointer.wave.easyship.editor;
...
import com.pointer.wave.easyship.android.*;
import com.pointer.wave.easyship.common.*;
...
public class TextEditor extends FreeScrollingTextField {
    ...
    public void setText(String var1, boolean b) {
        this.replaceText(0, this.getLength() - 1, var1.toString());
    }

    private String mKeyword;
    private int idx;
    private LinearSearchStrategy finder;
    public boolean findNext(String var1) {
        if (!var1.equals(this.mKeyword)) {
            this.mKeyword = var1;
            this.idx = 0;
        }
        ...
        if (var1.isEmpty()) {
            ...
            this.idx = this.finder.find(this.getText(), var1, this.idx, this.getText().length(), false, false);
            if (this.idx == -1) {
                this.selectText(false);
                ...
                this.setSelection(this.idx, this.mKeyword.length());
                this.idx += this.mKeyword.length();
                this.moveCaret(this.idx);
                var2 = true;
            }
        }
